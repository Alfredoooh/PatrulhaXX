...
import 'package:flutter/services.dart';          // ← MethodChannel fix
...
class _SettingsPageState extends State<SettingsPage> {
  ...
  void _pickLockDelay() {
    ...
    int idx = options.indexOf(_ts.lockDelay).clamp(0, options.length - 1);
    _showPickerSheet(
      title: 'Bloquear após',
      ...
      onConfirm: () { _ts.setLockDelay(options[idx]); setState(() {}); },
    );
  }
  ...
  Widget _label(String t) => Padding(
    ...
    child: Text(t, style: TextStyle(color: Colors.white.withOpacity(0.3),
      ...
      body: AnimatedBuilder(
        ...
        builder: (_, __) => ListView(
          ...
          children: [
            ...
            _Section(children: [
              _SwitchRow(
                svg: _iSettings, label: 'Tema escuro',
              ...
              _div(),
              _TapRow(
                svg: _iReload, label: 'Fundo de ecrã',
            ...
            _Section(children: [
              ...
              if (_lock) ...[
                ...
                _div(),
                _TapRow(
                  svg: _iSettings, label: 'Bloquear após',
            ...
            _Section(children: [
              _SwitchRow(
                svg: _iLock, label: 'Privacidade nos recentes',
              ...
              _div(),
              _SwitchRow(
                svg: _iLock, label: 'Bloquear capturas',
            ...
            _Section(children: [
              _TapRow(
                svg: _iSettings, label: 'Motor de pesquisa',
                sub: ThemeService.engines[_ts.engine] ?? 'Google',
                onTap: _pickEngine,
              ),
              _div(),
              _TapRow(
                svg: _iSettings, label: 'Volume máximo',
                sub: '${_ts.maxVolume}%',
                onTap: _pickVolume,
              ),
            ]),
            ...
            _Section(children: [
              _TapRow(
                svg: _iReload, label: 'Recarregar ícones',
              ...
              _div(),
              _TapRow(
                svg: _iTrash, label: 'Limpar downloads',
            ...
            _Section(children: [
              _TapRow(
                svg: _iSettings, label: 'patrulhaXX',
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Center(child: Container(width: 36, height: 4,
              decoration: BoxDecoration(color: Colors.white12,
                  borderRadius: BorderRadius.circular(2)))),
          const SizedBox(height: 16),
          const Text('Limpar downloads?', style: TextStyle(
          ...
          Row(children: [
            ...
            Expanded(child: GestureDetector(
              onTap: () async {
                ...
                for (final item in _svc.items.toList()) {
  ...
  DownloadService get _svc => DownloadService.instance;
}
...
class _TapRow extends StatelessWidget {
  ...
  const _TapRow({required this.svg, required this.label,
      required this.sub, required this.onTap, this.destructive = false});
...
class _SwitchRow extends StatelessWidget {
  ...
  const _SwitchRow({required this.svg, required this.label,
