...
class FeedVideo {
  ...
  final String pageUrl;       // ← ADICIONADO
  ...
  const FeedVideo({
    ...
    required this.pageUrl,    // ← ADICIONADO
  ...
  // fromRss — agora com pageUrl obrigatório
  static FeedVideo fromRss({
    required String title,
    required String thumb,
    required String embedUrl,
    required String pageUrl,   // ← ADICIONADO
